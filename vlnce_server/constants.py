...
REASON_OBSTACLE_REPLAN = "obstacle detected, replanning."
...
# Semantic landmark reward: bonus per newly-discovered named landmark.
REWARD_LANDMARK = "landmark"

# Obstacle replanning: depth threshold (metres) below which the central
# depth strip is considered blocked.
DEFAULT_OBSTACLE_DEPTH_THRESHOLD = 0.8
